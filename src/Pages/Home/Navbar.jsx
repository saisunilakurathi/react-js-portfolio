...
function Navbar() {
    ...
    return(
        <nav className={ `navbar ${navActive ? "active" : "" }`}>
            <div>
                <img src="./apple-icon-60x60.png" alt="LogoSai" />
            </div>
            ...
            <div className={`navbar--items ${navActive ? "active" : "" }`}>
                <ul>
                    ...
                    <li>
                        <Link onClick={closeMenu} activeClass="navBar--active--content" spy={true} smooth={true} offset={-70} duration={500} to="About Me" className="navbar--content">
                            About Me
                        </Link>
                    </li>
                    <li>
